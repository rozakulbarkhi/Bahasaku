...
<body>
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				...
				<div class="carousel-caption">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit dolore alias reprehenderit
						pariatur facilis quos, sit soluta quibusdam nemo a quasi, odio, dolorem magni maiores saepe
						distinctio officiis voluptas. Officia.</p>
				</div>
			</div>
	...
	<div class="container">
			...
			<div class="col-md-4">
				<div class="img-thumbnail">
					...
					<div class="caption">
						...
						<p class="text-center">"Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum,
							perferendis inventore dolorem rerum et tempora sint nemo illum ab saepe, assumenda, amet
							illo deleniti officiis, voluptatem maxime atque vero sunt."</p>
					</div>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<img src="img/target.png" width="350" height="350" alt="">
			</div>
		...
		<div class="row">
			<div class="col-md-6">
				<img src="img/gratiss.png" width="350" alt="">
			</div>

			<div class="col-md-6">
				<h4 class="pt-5 pr-5"><strong>Bebas Biaya</strong></h4>
				<p class="pr-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis ducimus quam illum
					similique cumque ratione cupiditate dolorem voluptate pariatur hic, rerum, et tempora earum iure
					ullam, id ea numquam, soluta!</p>
			</div>
		...
		<div class="row">
			<div class="col-md-6">
				<h4 class="pt-5 pl-5"><strong>Untuk Segala Jenjang</strong></h4>
				<p class="pl-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facilis ducimus quam illum
					similique cumque ratione cupiditate dolorem voluptate pariatur hic, rerum, et tempora earum iure
					ullam, id ea numquam, soluta!</p>
			</div>

			<div class="col-md-6">
				<img src="img/luas.png" width="400" alt="">
			</div>
		</div>

		<div class="row">
			<div class="col-md-6">
				<img src="img/random.png" width="400"  alt="">
			</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4 pt-5">
					...
					<p class="list-footer">Bahasaku adalah sebuah media pembelajaran berbasis web yang menyediakan
						berbagai materi sesuai dengan kurikulum yang terbaru. </p>
